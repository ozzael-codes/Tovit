...
Fork the project [on GitHub](https://github.ibm.com/Mridul-Bhandari/Tovit) and clone your fork
locally.

```text
$ git clone git@github.com:username/Tovit.git
$ cd Tovit-master
$ git remote add upstream https://github.ibm.com/Mridul-Bhandari/Tovit.git
$ git fetch upstream
```
...
Fixes: https://github.ibm.com/Mridul-Bhandari/Tovit/issues/1337
...
risks. If in doubt, you can always ask for guidance in the Pull Request from one of the collaborators.
...
`Mridul-Bhandari/Tovit` repository) is authorized to approve any other contributor's
