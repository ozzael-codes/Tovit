...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in Project Sample, creating a new issue in the `Mridul-Bhandari/Tovit`
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `Mridul-Bhandari/Tovit` in a concrete and reviewable manner.
...
When opening a new issue in the `Mridul-Bhandari/Tovit` issue tracker, please provide as much
