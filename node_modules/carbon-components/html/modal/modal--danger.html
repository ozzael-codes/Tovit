...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-j36gohj68j">Show
  modal</button>

<div data-modal id="modal-j36gohj68j" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-j36gohj68j-label" aria-describedby="modal-j36gohj68j-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-j36gohj68j-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-j36gohj68j-heading">Modal heading</p>
