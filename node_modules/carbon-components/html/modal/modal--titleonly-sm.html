...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-zz1826rr6qj">Show
  modal</button>

<div data-modal id="modal-zz1826rr6qj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-zz1826rr6qj-label" aria-describedby="modal-zz1826rr6qj-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-zz1826rr6qj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-zz1826rr6qj-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
