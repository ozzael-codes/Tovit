...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-77gy009xjbi">Show
  modal</button>

<div data-modal id="modal-77gy009xjbi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-77gy009xjbi-label" aria-describedby="modal-77gy009xjbi-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-77gy009xjbi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-77gy009xjbi-heading">Modal heading</p>
