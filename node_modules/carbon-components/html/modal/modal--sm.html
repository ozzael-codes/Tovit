...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-1y07dear67o">Show
  modal</button>

<div data-modal id="modal-1y07dear67o" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-1y07dear67o-label" aria-describedby="modal-1y07dear67o-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1y07dear67o-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1y07dear67o-heading">Modal heading</p>
