...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-cny74ed8504">Show
  modal</button>

<div data-modal id="modal-cny74ed8504" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-cny74ed8504-label" aria-describedby="modal-cny74ed8504-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-cny74ed8504-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-cny74ed8504-heading">Modal heading</p>
