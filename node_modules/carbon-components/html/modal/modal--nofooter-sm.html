...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-w5bizna7ora">Show
  modal</button>

<div data-modal id="modal-w5bizna7ora" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-w5bizna7ora-label" aria-describedby="modal-w5bizna7ora-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-w5bizna7ora-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-w5bizna7ora-heading">Modal heading</p>
