...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-bck82fw95a">Show
  modal</button>

<div data-modal id="modal-bck82fw95a" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-bck82fw95a-label" aria-describedby="modal-bck82fw95a-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-bck82fw95a-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-bck82fw95a-heading">Modal heading</p>
