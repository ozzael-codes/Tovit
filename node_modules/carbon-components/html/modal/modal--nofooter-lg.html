...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-r711w7qnc3">Show
  modal</button>

<div data-modal id="modal-r711w7qnc3" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-r711w7qnc3-label" aria-describedby="modal-r711w7qnc3-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-r711w7qnc3-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-r711w7qnc3-heading">Modal heading</p>
