...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-f5akb2w0p8d">Show
  modal</button>

<div data-modal id="modal-f5akb2w0p8d" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-f5akb2w0p8d-label" aria-describedby="modal-f5akb2w0p8d-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-f5akb2w0p8d-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-f5akb2w0p8d-heading">Modal heading</p>
