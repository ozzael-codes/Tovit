...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rwov973azp">Show
  modal</button>

<div data-modal id="modal-rwov973azp" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rwov973azp-label" aria-describedby="modal-rwov973azp-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rwov973azp-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rwov973azp-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
