...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-cwo4mpwkmos">Show
  modal</button>

<div data-modal id="modal-cwo4mpwkmos" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-cwo4mpwkmos-label" aria-describedby="modal-cwo4mpwkmos-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-cwo4mpwkmos-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-cwo4mpwkmos-heading">Modal heading</p>
