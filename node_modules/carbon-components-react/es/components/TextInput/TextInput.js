...
var TextInput = /*#__PURE__*/React.forwardRef(function TextInput(_ref, ref) {
  ...
  var inputWrapperClasses = classNames("".concat(prefix, "--form-item"), "".concat(prefix, "--text-input-wrapper"), _defineProperty({}, "".concat(prefix, "--text-input-wrapper--light"), light));
